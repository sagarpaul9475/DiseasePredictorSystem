        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 items-center">
          ...
          <TextField
            ...
            onChange={(event) => {
              ...
              setEmailExists("");
              if (email?.current) email.current = event.target.value;
            }}
            color="success"
            required
          />
          ...
          <TextField
            ...
            onChange={(event) => {
              ...
              if (username?.current) username.current = event.target.value;
            }}
            color="success"
            required
          />
          ...
          <TextField
            ...
            onChange={(event) => {
              ...
              if (password?.current) password.current = event.target.value;
            }}
