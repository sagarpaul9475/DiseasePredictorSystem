...
<button
          className="bg-white text-teal-500  hover:scale-105 w-16 py-1 rounded focus:outline-none focus:ring-2 focus:ring-teal-500"
          onClick={() => setIsMonthDropdownOpen(!isMonthDropdownOpen)}
>
{getMonthName(selectedMonth)}
</button>
{isMonthDropdownOpen && (
<div className="absolute mt-2 py-1 w-20 overflow-y-auto bg-white rounded shadow-lg z-10">
...
<button
          className="bg-white text-gray-700 hover:scale-105 w-16 py-1 rounded focus:outline-none focus:ring-2 focus:ring-gray-500"
          onClick={() => setIsYearDropdownOpen(!isYearDropdownOpen)}
>
{selectedYear}
</button>
{isYearDropdownOpen && (
<div className="absolute mt-2 py-1 w-24 max-h-44 overflow-y-auto bg-white rounded shadow-lg z-10">
...
const isSelected = date.toDateString() === selectedDate.to
...
>
<div className="flex items-center justify-center h-full w-full">{i}</div>
</div>
);
}
return calendar;
...
return (
<div className="w-full rounded-lg flex overflow-scroll flex-col items-center gap-4 p-4 bg-white shadow-lg">
...
<div className="flex flex-col rounded-e-md justify-center items-center gap-4 p-2 bg-gray-100 w-full">
